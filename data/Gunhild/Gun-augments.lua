...
----------------------
	...
	Lugh.MAB = { 
		name="Lugh's Cape", 
		augments={'INT+20','Mag. Acc+20 /Mag. Dmg.+20','"Mag.Atk.Bns."+6'}
	}
-------------------------
--  White Mage Capes   --
-------------------------
...
----------------------------------------------------------------------
    ...
    Merl.Head.Burst = {
		name="Merlinic Hood", 
		augments={'"Mag.Atk.Bns."+26','Magic burst dmg.+10%','INT+6','Mag. Acc.+7'}
	}
    ------------------
    --  Merl. Body  --
    ------------------
    ...
    Merl.Legs.Burst = {
		...
		augments={'Mag. Acc.+23 "Mag.Atk.Bns."+23','Magic burst dmg.+10%','"Mag.Atk.Bns."+2'}
	} 
    ------------------
    --  Merl. Feet  --
    ------------------
    Merl.Feet.Burst = {
		...
		augments={'Mag. Acc.+24 "Mag.Atk.Bns."+24','Magic burst dmg.+5%','"Mag.Atk.Bns."+5'}
	} 
	Chir = {}
    Chir.Head = {}
    Chir.Body = {}
